...
const WardenStudents = () => {
        ...
        const fetchStudents = async () => {
            try {
                ...
                const res = await axios.get(
                    `${import.meta.env.VITE_APP_API}/hostel/warden-students`,
                    {
                        headers: {
    ...
    const filteredStudents = students.filter((student) => {
        ...
        return (
            ...
            (student.enrolmentNo && student.enrolmentNo.toLowerCase().includes(term)) ||
            (student.indexNo && student.indexNo.toLowerCase().includes(term))
        );
    });
    ...
    return (
        <div className="mt-8">
            ...
            {/* Use your DefaultInput component here */}
            <DefaultInput
            ...
            {totalPages > 1 && (
                <div className="mt-4 flex justify-center gap-4 text-gray-700">
                    ...
                    <span className="px-3 py-1 font-semibold" aria-live="polite">
